      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <div className="flex justify-center">
            ...
            <SocialIcon url="https://github.com/chandms" className="inline-flex text-white border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 rounded text-lg mr-5"/>
            <SocialIcon url="https://www.facebook.com/cooleo.co.in" className="inline-flex text-white border-0 py-2 px-6 focus:outline-none hover:bg-blue-900 rounded text-lg mr-5"/>
          </div>
          <br></br>
        </div>
        <CarouselComponent/>
