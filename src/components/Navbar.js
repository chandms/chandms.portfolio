...
export default function Navbar() {
  return (
    ...
    <header className="bg-purple-200 md:sticky lg:sticky top-0 z-10">
      <div className=" container place-content-evenly mx-auto flex flex-wrap p-5 md:flex-row items-center">
        ...
        <a
          href="#contact"
          className="inline-flex items-center bg-fuchsia-300 border-0 py-1 px-2 focus:outline-none hover:bg-blue-400 rounded text-base mt-4 md:mt-0">
          Contact Me
